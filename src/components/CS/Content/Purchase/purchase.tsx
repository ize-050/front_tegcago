        ...
        <>
            <div className="p-5 mx-auto  text-black">
                ...
                <div className=" flex  flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4 mt-5">
                    ...
                    <div className="w-full md:w-1/2  flex flex-col">
                        <label
                          className="block mb-2 text-lg text-gray-500  text-sm font-semibold">บริการหัวรถลาก</label>
                        <p>{data?.d_truck}</p>
                    </div>
                </div>
                ...
                <div className=" flex  flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4 mt-5">
                    ...
                    <div className="w-full md:w-1/2 flex flex-col">
                        <label
                          className="block mb-2 text-lg text-gray-500  text-sm font-semibold">ที่อยู่ปลายทาง </label>
                ...
                <div className=" flex  flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4 mt-5 ">
                    <div className="w-full md:w-1/2 flex flex-col">
                        <label className="block mb-2 text-lg text-gray-500  text-sm font-semibold">Refund Tax
                            ต้นทาง</label>
                          ...
                          <Fragment key={index}>
                              <div className="bg-gray-200 p-5 border rounded-md shadow-sm mb-5">
                                  <div className="flex justify-between items-center mb-4">
                                      ...
                                      <a href="#" className="text-blue-500 items-end underline">รายละเอียด</a>
                                  </div>
