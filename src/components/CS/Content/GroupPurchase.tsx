...
import ModalwatchDocument from "./Modal/ModalwatchDocument";
    ...
    <>
      <div className="lg:flex md:flex ">
        <div className="flex-1 p-5">
          <p className="text-black text-xl font-bold">รายละเอียด</p>
        </div>
        <div className="justify-end p-5">
          {purchase?.d_emp_look == "" ? (
            ...
            <>
              ...
              <Button
                className="border-[#273A6F]  bg-[#417CA0] mr-5"
                style={{
                  color: "#FFFFFF",
                }}
                onClick={() => {
              ...
              >
                <Lucide
                  icon={"FilePlus"}
                  className="inset-y-0 bg-secondary-400  color-[#417CA0] mr-1  justify-center m-auto   w-5 h-5  text-slate-500"
                ></Lucide>
                เอกสารที่ขอเพิ่ม :
              </Button>
            </>
      ...
      <div className="container mx-auto px-5 ">
        ...
        {modelAdddo ? <ModalAdddocument></ModalAdddocument> : null}
