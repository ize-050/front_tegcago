...
const ModalAdddocument = () => {
  ...
  return (
    <>
      <div
        className="text-black  justify-center items-center flex  fixed inset-0 z-50 outline-none focus:outline-none"
      >
        <div className="relative w-full my-6 mx-auto max-w-2xl  max-h-[700px]  overflow-scroll">
          {/*content*/}
