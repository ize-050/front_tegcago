                ...
                <div className="mx-auto text-black">
                    <div className="flex bg-gray-50">
                        <div className=" flex-1 w-50  px-5  rounded-md">
                            <h1 className="mb-5  text-1xl font-semibold">รายละเอียดการยืนยันวันออกเดินทาง</h1>
                        </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="flex">
                            <div className="w-1/2 p-5">
                                <label className="block mb-2 text-lg text-gray-500  sm:text-sm font-semibold">วันที่ ETD *</label>
                        ...
                        <div className="flex">
                            ...
                            <div className="w-1/2 p-5">
                                <label className="block mb-2 text-lg text-gray-500  sm:text-sm font-semibold">Port ต้นทาง.</label>
                            ...
                            <div className="w-1/2 p-5">
                                <label className="block mb-2 text-lg text-gray-500  sm:text-sm font-semibold">Port ปลายทาง.</label>
                        ...
                        <div className="flex">
                            ...
                            <div className="w-1/2 p-5">
                                <label className="block mb-2 text-lg text-gray-500  sm:text-sm font-semibold">Vessel's Name *</label>
