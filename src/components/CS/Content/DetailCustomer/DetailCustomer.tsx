...
const DetailCustomer = () => {
    ...
    const onSubmit = async (data: any) => {
        try {
            ...
            await dispatch(submitChangeUpdateCustomer(Request))
                ...
                <FormProvider {...methods}>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="flex   flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4">
                            <div className="flex  w-1/3 md:flex-row md:space-y-0 md:space-x-4">
                                <div className="w-full flex flex-col">
                                    <label
                                      className="block mb-2 text-lg text-gray-700  text-sm font-semibold">ความสนใจ</label>
                                    <Controller
                                      name="cus_status"
                                      control={control}
                                      rules={{required: true}}
                            ...
                            <div className="w-full  flex flex-col">
                                <label
                                  className="block mb-2 text-lg text-gray-700 font-semibold text-sm">ช่องทางการติดต่อ</label>
                                <Controller
                                  name="cus_etc"
                                  control={control}
                                  rules={{required: true}}
                            ...
                            <div className="w-full  flex flex-col">
                                <label
                                  className="block mb-2 text-lg text-gray-700  text-sm font-semibold">กลุ่มลูกค้า</label>
                                <Controller
                                  name="cd_group_id"
                                  control={control}
                                  rules={{required: true}}
                                  render={({field: {onChange, onBlur, value}}) => (
                                    <select
                                      ...
                                      className=" border border-gray-200 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        ...
                                        {customerGroup.length > 0 && customerGroup.map((data,key)=>{
                                            return(
                                                <option key={key} value={data.id}>{data.group_name}</option>
                                            )
                                        })
