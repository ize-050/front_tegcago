            ...
            <div className="p-5 mx-auto  text-black">
                ...
                <div className=" flex  flex-col  md:flex-row  mt-5">
                    <div className="w-full md:w-1/3 flex flex-col">
                        <label className="block mb-2 text-lg text-gray-700  text-sm font-semibold">ตำแหน่งผู้ติดต่อ</label>
                ...
                <div className=" flex  flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4 mt-5 mb-5">
                    <div className="w-full md:w-1/3 flex flex-col">
                        ...
                        <button className={`badge  ${customer_detail.color} max-w-20 text-white  text-center   rounded-md`}
                        >
                            {customer_detail.cus_status}
                        </button>
                    </div>
                    <div className="w-full md:w-1/3 flex flex-col">
                        <label className="block mb-2 text-lg text-gray-700  text-sm font-semibold">ช่องทางการติดต่อ</label>
                        <p
                    ...
                    <div className="w-full md:w-1/3 flex flex-col">
                        <label className="block mb-2 text-lg text-gray-700  text-sm font-semibold">อายุ (โดยประมาณ)</label>
                ...
                <div className=" flex  flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4 mt-5 mb-5">
                    <div className="w-full md:w-1/2 flex flex-col">
                        <label className="block mb-2 text-lg text-gray-700  text-sm font-semibold">Wechat</label>
                        <p>{customer_detail.cus_wechat}</p>
                    </div>
                    {/* <div className="w-full md:w-1/2 flex flex-col">
                            <label className="block mb-2 text-lg text-gray-700  text-sm font-semibold">กลุ่มลูกค้า</label>
                            <p>{customer_detail.cus_etc}</p>
                        </div> */}
                ...
                <div className=" flex  flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4 mt-5">
                    ...
                    <div className="w-full md:w-1/3 flex flex-col">
                        <label className="block mb-2 text-lg text-gray-700  text-sm font-semibold">ประเภทสินค้านำเข้า-ส่งออก</label>
                ...
                <div className=" flex  flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4 mt-5">
                    <div className="w-full md:w-1/3 flex flex-col">
                        <label className="block mb-2 text-lg text-gray-700  text-sm font-semibold">ประเภทใช้บริการ</label>
                ...
                <div className=" flex  flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4 mt-5">
                    ...
                    <div className="w-full md:w-1/3 flex flex-col">
                        <label className="block mb-2 text-lg text-gray-700  text-sm font-semibold">ขึ้นทะเบียนผู้นำเข้า</label>
