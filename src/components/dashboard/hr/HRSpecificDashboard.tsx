...
const HRSpecificDashboard: React.FC = () => {
  const router = useRouter();

  const dashboardCards = [
    {
      title: 'HR Dashboard',
      description: 'ภาพรวมการจัดการทรัพยากรบุคคลของฉัน',
      icon: Users,
      color: 'bg-orange-500',
      path: '/hr/dashboard',
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">ภาพรวมการจัดการทรัพยากรบุคคลของฉัน</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-gray-500">การจัดส่ง</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-orange-600">95%</div>
            <div className="text-sm text-gray-500">ประสิทธิภาพ</div>
          </div>
        </div>
      </div>
    </div>
...
export default HRSpecificDashboard;
