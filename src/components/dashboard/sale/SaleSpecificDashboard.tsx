...
const SaleSpecificDashboard: React.FC = () => {
  const router = useRouter();

  const dashboardCards = [
    {
      title: 'Sale Dashboard',
      description: 'ภาพรวมยอดขายและผลงานเซลล์ของฉัน',
      icon: TrendingUp,
      color: 'bg-blue-500',
      path: '/sale/dashboard',
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Sale Dashboard</h1>
          <p className="text-sm text-gray-500 mt-1">ภาพรวมยอดขายและผลงานของฉัน</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-orange-600">฿340K</div>
...
export default SaleSpecificDashboard;
