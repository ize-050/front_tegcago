                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    <div className="relative p-6 flex-auto">
                                            ...
                                            <Controller
                                                ...
                                                render={({ field: { onChange, onBlur, value } }) => (
                                                    <input
                                                        ...
                                                        onChange={onChange}
                                                        type="text" className={`
                                            ${errors.cd_company ? 'border-red-500' : 'border-gray-200'}
                                            px-4 py-2 outline-none rounded-md w-full`} />
                                                )}

                                            />
                                            {errors.cd_company && <p className="text-red-500">กรุณากรอกชื่อบริษัท.</p>}
                                        </div>
                                        <div className="mb-5">
                                            <label className="block flex mb-1 text-gray-600 font-semibold">ชื่อลูกค้า
                                                <div className="text-red-500">
                                                    *
                                                </div></label>
                                            <Controller
                                                ...
                                                render={({ field: { onChange, onBlur, value } }) => (
                                                    <input
                                                        ...
                                                        onChange={onChange}
                                                        type="text" className={`
                                            ${errors.cus_fullname ? 'border-red-500' : 'border-gray-200'}
                                            px-4 py-2 outline-none rounded-md w-full`} />
                                                )}

                                            />
                                            {errors.cus_fullname && <p className="text-red-500">กรุณากรอก ชื่อ-นามสกุล.</p>}
                                        </div>
                                        <div className="mb-5">
                                            <label className="block mb-1 text-gray-600 font-semibold">เบอร์โทรศัพท์</label>
                                            <Controller
                                                name="cus_phone"
                                                control={control}
                                                ...
                                                render={({ field: { onChange, onBlur, value } }) => (
                                                    <input
                                                        ...
                                                        onChange={onChange}
                                                        type="text" className={`
                                            ${errors.cus_phone ? 'border-red-500' : 'border-gray-200'}
                                            px-4 py-2 outline-none rounded-md w-full`} />
                                                )}

                                            />
                                            {errors.cus_phone && <p className="text-red-500">กรุณากรอกเบอร์โทรศัพท์.</p>}
                                        </div>

                                        <div className="mb-5">
                                            <label className="block mb-1 text-gray-600 font-semibold">ID Line</label>
                                            <Controller
                                                name="cus_line"
                                                control={control}
                                                rules={{ required: true, maxLength: 10 }}
                                                render={({ field: { onChange, onBlur, value } }) => (
                                                    <input
                                                        ...
                                                        onChange={onChange}
                                                        type="text" className={`
                                            ${errors.cus_line ? 'border-red-500' : 'border-gray-200'}
                                            px-4 py-2 outline-none rounded-md w-full`} />
                                                )}

                                            />
                                            {errors.cus_line && <p className="text-red-500">กรุณากรอกID Line.</p>}
                                        </div>

                                        <div className="mb-5">
                                            <label className="block mb-1 text-gray-600 font-semibold">Website</label>
                                            <Controller
                                                name="cus_website"
                                                control={control}
                                                rules={{ required: true }}
                                                render={({ field: { onChange, onBlur, value } }) => (
                                                    <input
                                                        ...
                                                        onChange={onChange}
                                                        type="text" className={`
                                            ${errors.cus_website ? 'border-red-500' : 'border-gray-200'}
                                            px-4 py-2 outline-none rounded-md w-full`} />
                                                )}

                                            />
                                            {errors.cus_website && <p className="text-red-500">กรุณากรอกID Line.</p>}
                                        </div>

                                        <div className="mb-5">
                                            <label className="block mb-1 text-gray-600 font-semibold">ความสนใจ</label>
                                            <Controller
                                                name="cus_status"
                                                control={control}
                                                rules={{ required: true }}
                                        ...
                                        <div className="mb-5">
                                            <label className="block mb-1 text-gray-600 font-semibold">ช่องทางการติดต่อ</label>
                                            <Controller
                                                name="cus_etc"
                                                control={control}
                                                rules={{ required: true }}
