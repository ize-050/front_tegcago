...
import { getCustomerDetail ,getCustomerGroup } from '@/services/customer'
//store
...
//store
import { customerData, ChangeFormEdit, setCustomerGroup } from '@/stores/customer'
    ...
    useEffect(() => {
        ...
        const fetchCustomerGroup = async() =>{
          const customerGroup =   await getCustomerGroup()
            dispatch(setCustomerGroup(customerGroup))
        }
            ...
            <div className="container mx-auto px-5 ">
                ...
                >
                    ...
                    {activeTab === "customerDetail" ?
                      formEditcustomer ? <ViewCustomer /> : <DetailCustomer /> :''
